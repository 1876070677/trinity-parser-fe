  ...
  return (
    <div className="space-y-4 p-1 pr-2">
      ...
      <form onSubmit={handleSubmit} className="space-y-2">
        <div className="flex items-center gap-2 bg-[#F8F9FA] border border-black/[0.04] p-1.5 rounded-2xl focus-within:bg-white focus-within:border-gray-300 focus-within:ring-2 focus-within:ring-black/5 focus-within:shadow-xs transition-all duration-200">
          <Input
      ...
      <div className="space-y-3">
        {(!subjects || subjects.length === 0) ? (
          <div className="text-center py-12 px-4 bg-[#F8F9FA] border border-black/[0.04] rounded-2xl">
          ...
          subjects.map((subject) => {
            ...
            return (
              <div
                ...
                className="bg-[#F8F9FA] border border-black/[0.04] hover:bg-white rounded-2xl p-4 transition-all duration-200 space-y-3 shadow-2xs hover:shadow-xs group"
              >
                    ...
                    >
                      <RefreshCw
                        className={`w-3.5 h-3.5 ${
                          refreshingKey === `${subject.sujtNo}-${subject.classNo}`
